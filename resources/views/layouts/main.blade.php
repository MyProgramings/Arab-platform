                    ...
                    <li class="nav-item {{ request()->is('videos*', 'channel*', 'history') ? 'active' : '' }} dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left px-2 text-right mt-2">
                            <div class="pb-1">
                                <div class=" space-y-1">
                                    @auth
                                        <x-jet-responsive-nav-link href="{{ route('videos.create') }}" :active="request()->routeIs('videos.create')"
                                            class="dropdown-item  p-0">
                                            <i class="fas fa-upload"></i> {{ __('رفع فيديو') }}
                                        </x-jet-responsive-nav-link>

                                        <x-jet-responsive-nav-link href="{{ route('channel.index') }}" :active="request()->routeIs('channel.index')"
                                            class="dropdown-item  p-0">
                                            <i class="far fa-folder"></i> {{ __('فئات الكورسات') }}
                                        </x-jet-responsive-nav-link>

                                        <x-jet-responsive-nav-link href="{{ route('videos.index') }}" :active="request()->routeIs('videos.index')"
                                            class="dropdown-item  p-0">
                                            <i class="far fa-play-circle"></i> {{ __('فيديوهاتي') }}
                                        </x-jet-responsive-nav-link>

                                        <x-jet-responsive-nav-link href="{{ route('history') }}" :active="request()->routeIs('history')"
                                            class="dropdown-item p-0">
                                            <i class="fas fa-history"></i> {{ __('سجل المشاهدة') }}
                                        </x-jet-responsive-nav-link>
                                    @endauth
                                </div>
                            </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-left px-2 text-right mt-2">
                                ...
                                <div class="pt-4 pb-1 border-t border-gray-200">
                                    <div class="flex items-center px-4">
                                        ...
                                        <div class="ml-3">
                                            <div class="font-medium text-base text-gray-800">{{ Auth::user()->user_name }}
                                            </div>
                                        ...
                                        @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                                            ...
                                            @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                                                <x-jet-responsive-nav-link href="{{ route('teams.create') }}"
                                                    :active="request()->routeIs('teams.create')" class="dropdown-item">
                                                    {{ __('site.new_team') }}
                                                </x-jet-responsive-nav-link>
                                            @endcan
